...
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: bigint, arg6: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async createProduct(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: Array<string>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateOrderPaymentStatus(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: boolean, arg5: Array<string>): Promise<void> {
        if (this.processError) {
            try {
